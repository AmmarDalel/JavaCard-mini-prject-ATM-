...
public class initialiser extends JFrame {
...
JLabel lblNewLabel_3 = new JLabel("0 TND");
lblNewLabel_3.setFont(new Font("Tahoma", Font.PLAIN, 13));
lblNewLabel_3.setBounds(138, 106, 150, 25);
panel_3.add(lblNewLabel_3);

JLabel lblNewLabel_1 = new JLabel("Your Balance is initialized  :");
lblNewLabel_1.setFont(new Font("Tahoma", Font.BOLD, 16));
lblNewLabel_1.setBounds(72, 71, 308, 25);
...
lblNewLabel.setIcon(new ImageIcon(initialiser.class.getResource("/atm_sys/CASH3.png")));
lblNewLabel.setBounds(88, 640, 300, 36);
getContentPane().add(lblNewLabel);

JLabel lblNewLabel_4 = new JLabel("");
lblNewLabel_4.setIcon(new ImageIcon(initialiser.class.getResource("/atm_sys/lecteur.png")));
